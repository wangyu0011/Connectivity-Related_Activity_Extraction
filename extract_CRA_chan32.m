...
PATH2='./';
cd(PATH1);
list_ch=[1,7,19,36,54,68,85,100,115,15,17,23,28,30,34,43,48,58,61,66,71,78,80,91,93,98,103,106,112,119,122,127];
list2=dir('TF*.mat');
...
%         B3=-B3;
    ...
    save([PATH2,'chan32_',list2(s1).name],'Data');
end
